...
function(setup_coverage)
  ...
  _setup_coverage_html("${coverage_target}"
    "${GCOVR_EXECUTABLE}"
    "${gcovr_args}"
    "${output_dir}"
  )
  _setup_coverage_text("${coverage_target}"
    "${GCOVR_EXECUTABLE}"
    "${gcovr_args}"
    "${output_dir}"
  )

  add_custom_target(${coverage_target} DEPENDS ${coverage_target}-text)
endfunction()
